...
[DependsOn(
    typeof(AgentOpsApplicationTestModule),
    typeof(AgentOpsEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class AgentOpsEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new AgentOpsDbContext(new DbContextOptionsBuilder<AgentOpsDbContext>().UseSqlite(_database.ConnectionString).Options));
